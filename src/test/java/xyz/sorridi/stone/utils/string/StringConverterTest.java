...
class StringConverterTest
{
    ...
    void fromSneakToCamel(String string)
    {
        String converted = StringConverter.fromSneakToCamel(string);
    ...
    {
        var plur = Array.of(" giorni", " ore", " minuti", " secondi", " millisecondi");
        var sing = Array.of(" giorno", " ora", " minuto", " secondo", " millisecondo");
